...
// OPTIMIZED: max 50→30, initial 12→8 for mobile-safe performance
...
class AdaptiveConcurrencyController {
  ...
  static const int _maxConcurrency = 30;
  ...
  int effectiveConcurrency({required int totalIps, int max = 30}) {
